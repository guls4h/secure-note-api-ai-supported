          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mb-4 max-w-md">
                A modern, elegant solution for storing your private notes with 
                end-to-end encryption and a beautiful interface.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/notes" className="text-muted-foreground hover:text-primary transition-colors">
                    My Notes
                  </Link>
                </li>
                <li>
